...
#if defined(AIXLOG_ONE_LOG_ENTRY_PER_CALL)
  #define AIXLOG_INTERNAL_LINE_PER_LOG std::endl
#else
  #define AIXLOG_INTERNAL_LINE_PER_LOG ""
#endif
...
#define LOG(...) AIXLOG_INTERNAL__VAR_PARM(,##__VA_ARGS__, AIXLOG_INTERNAL__LOG_SEVERITY_TAG(__VA_ARGS__), AIXLOG_INTERNAL__LOG_SEVERITY(__VA_ARGS__)) << TIMESTAMP << FUNC << AIXLOG_INTERNAL_LINE_PER_LOG
#define SLOG(...) AIXLOG_INTERNAL__VAR_PARM(,##__VA_ARGS__, AIXLOG_INTERNAL__LOG_SEVERITY_TAG(__VA_ARGS__), AIXLOG_INTERNAL__LOG_SEVERITY(__VA_ARGS__)) << TIMESTAMP << SPECIAL << FUNC << AIXLOG_INTERNAL_LINE_PER_LOG
